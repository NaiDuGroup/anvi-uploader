...
const CreateOrderModal = dynamic(() => import("./_components/CreateOrderModal"), { ssr: false });
const EditOrderModal = dynamic(() => import("./_components/EditOrderModal"), { ssr: false });
const IssueReasonModal = dynamic(() => import("./_components/IssueReasonModal"), { ssr: false });
const CommentPanel = dynamic(() => import("./_components/CommentPanel"), { ssr: false });
