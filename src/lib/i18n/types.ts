...
export interface TranslationDictionary {
  ...
  admin: {
    ...
    designStudio: {
      ...
      archived: string;
      template: string;
      sizeCm: (w: number, h: number) => string;
      createTitle: string;
      nameLabel: string;
      defaultTitle: string;
      ...
      orderPrefillLoading: string;
      orderPrefillNoRender: string;
      orderPrefillFileFailed: string;
    };
    trashTitle: string;
