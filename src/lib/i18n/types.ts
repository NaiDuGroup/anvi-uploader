...
export interface TranslationDictionary {
  ...
  admin: {
    ...
    catalogNewCategory: string;
    catalogNewProduct: string;
    catalogEditCategory: string;
    catalogEditProduct: string;
    catalogDeleteCategory: string;
    catalogDeleteProduct: string;
    catalogDeleteCategoryConfirm: string;
    catalogDeleteProductConfirm: string;
    catalogName: string;
    catalogSlug: string;
    ...
    catalogNoCategories: string;
    catalogNoProducts: string;
    noResults: string;
    catalogAttributeFields: string;
    catalogAddField: string;
    catalogFieldKey: string;
    catalogFieldType: string;
    catalogFieldRequired: string;
    catalogFieldOptions: string;
    catalogAddOption: string;
    catalogFieldLabel: string;
    catalogFieldMin: string;
    catalogFieldMax: string;
    catalogFieldDefault: string;
    catalogSelectCategory: string;
    orderItems: string;
    addItem: string;
    removeItem: string;
    ...
    customerProvidedHint: string;
    noProductsInCategory: string;
    quantity: string;
    itemNotes: string;
    orderPosition: (n: number) => string;
    catalogSearchCategories: string;
    catalogSearchProducts: string;
    catalogProductsCount: string;
    catalogFieldsCount: string;
    filterByCategory: string;
    filterByCategoryAll: string;
    pricingModel: string;
    pricingFixed: string;
    pricingPerSqm: string;
